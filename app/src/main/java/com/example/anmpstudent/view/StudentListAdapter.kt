...
//        val view = inflater.inflate(R.layout.student_list_item, parent,false)
    ...
    override fun onButtonDetailClick(v: View) {
        val studentId = v.tag as String // Extract student ID from the tag
        val action = StudentListFragmentDirections.actionStudentDetail(studentId) // Pass the student ID as argument
